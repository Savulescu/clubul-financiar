...
CATS = [
    ("buget", "💰 Buget personal"), ("economii", "🐖 Economii"), ("datorii", "✂️ Datorii"),
...
<title>{title} — Clubul Financiar</title><meta name="description" content="{desc}"><meta name="robots" content="index, follow"><meta name="theme-color" content="#10b981">
...
<meta property="og:title" content="{title}"><meta property="og:description" content="{desc}"><meta property="og:url" content="https://clubulfinanciar.ro/articole/{slug}.html"><meta property="og:image" content="https://clubulfinanciar.ro/og-image.png">
<meta name="twitter:card" content="summary_large_image"><meta name="twitter:title" content="{title}"><meta name="twitter:image" content="https://clubulfinanciar.ro/og-image.png">
...
<link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@400;500;600;700;800&family=Sora:wght@600;700;800&display=swap" rel="stylesheet">
<link rel="stylesheet" href="/assets/style.css?v={v}"><link rel="stylesheet" href="/assets/upgrade.css?v={v}"></head><body><article class="article"><p class="meta"><a href="/educatie.html">Educație</a> · <a href="/educatie.html#{cat}">{catname}</a> · {min} min citire</p><h1>{title}</h1>{body}<div class="disc">⚠️ Conținut educativ, nu sfat de investiții. Pentru decizii financiare consultă un specialist autorizat.</div><p style="margin-top:26px"><a class="btn btn-ghost" href="/educatie.html">← Toate articolele</a></p></article><script src="https://cdn.jsdelivr.net/npm/@supabase/supabase-js@2"></script><script src="/assets/article.js?v={v}"></script><script src="/assets/site.js?v={v}"></script></body></html>'''

def build_page(slug, title, desc, cat, body):
    mins = reading_minutes(body)
    ld = json.dumps({
        "@context":"https://schema.org","@type":"Article","headline":title,"description":desc,
        "inLanguage":"ro-RO","publisher":{"@type":"Organization","name":"Clubul Financiar",
...
<meta property="og:type" content="website"><meta property="og:site_name" content="Clubul Financiar"><meta property="og:locale" content="ro_RO"><meta property="og:title" content="Educație financiară — articole și ghiduri"><meta property="og:description" content="Cea mai completă bibliotecă RO de educație financiară."><meta property="og:url" content="https://clubulfinanciar.ro/educatie.html"><meta property="og:image" content="https://clubulfinanciar.ro/og-image.png">
<meta name="twitter:card" content="summary_large_image"><meta name="twitter:title" content="Educație financiară — articole și ghiduri"><meta name="twitter:image" content="https://clubulfinanciar.ro/og-image.png">
<script>(function(){var t=localStorage.getItem("cf-theme");if(t)document.documentElement.setAttribute("data-theme",t);})();</script>
<link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@400;500;600;700;800&family=Sora:wght@600;700;800&display=swap" rel="stylesheet">
...
eduQ&&eduQ.addEventListener("input",()=>{
  ...
  eduCards.forEach(c=>{const v=!q||c.dataset.s.includes(q);c.style.display=v?"":"none";if(v)shown++;});
...
<script src="https://cdn.jsdelivr.net/npm/@supabase/supabase-js@2"></script><script src="/assets/site.js?v=__V__"></script></body></html>'''
...
try:
    ...
    for t in gterms:
        ...
        seen.add(fold(term))
        idx.append({"t": term, "d": deff[:140], "u": "/glosar.html#" + slugify(term), "k": "g"})
...
h = re.sub(r'<div class="num">25\+</div>', f'<div class="num">{total}+</div>', h)
h = re.sub(r'<div class="num">8</div><div class="lbl">Calculatoare financiare</div>', '<div class="num">11</div><div class="lbl">Calculatoare financiare</div>', h)
h = re.sub(r'<div class="num">9</div><div class="lbl">Categorii acoperite</div>', '<div class="num">16</div><div class="lbl">Categorii acoperite</div>', h)
h = h.replace("Bibliotecă · 110 articole", f"Bibliotecă · {total} articole")
h = h.replace("Vezi toate cele 110 articole", f"Vezi toate cele {total} articole")
